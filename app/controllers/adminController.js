...
const createAdmin = async (req, res) => {
  ...
  try {
      ...
      const token = generateUserToken(dbResponse.email, dbResponse.id, is_admin, dbResponse.first_name, dbResponse.last_name);
    ...
    return res.status(status.conflict).send(errorMessage)l
  }
};
